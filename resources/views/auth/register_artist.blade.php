...
<head>
    ...
    <title>Register as Artist - ArtSpace</title>
    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="auth-header">
                ...
                <p class="subtitle">Showcase and sell your artwork</p>
                <span class="role-badge">
                    <i class="fas fa-star"></i> Artist Account
                </span>
            </div>
            ...
            <form method="POST" action="{{ route('register.artist') }}">
                ...
                <button type="submit" class="btn-register">
                    <i class="fas fa-check-circle"></i> Create Artist Account
                </button>

                <!-- Footer -->
                <div class="auth-footer">
                    <p>Just looking to buy artwork?</p>
