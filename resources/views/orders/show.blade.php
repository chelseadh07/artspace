                ...
                <div class="card card-hover">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            @else
                                <span
                                    class="badge bg-secondary p-2">{{ ucfirst(str_replace('_', ' ', $order->status)) }}</span>
                            @endif
                        </div>
                                ...
                                <form action="{{ route('orders.updateStatus', $order) }}" method="POST">
                                    ...
                                    <select name="status" class="form-select form-select-sm">
                                        ...
                                        <option value="in_progress"
                                            {{ $order->status === 'in_progress' ? 'selected' : '' }}>In Progress</option>
                    ...
                    <div class="card-body">
                        ...
                        @else
                            ...
                            <div class="mb-4">
                                ...
                                @else
                                    <span
                                        class="badge bg-secondary p-2">{{ ucfirst(str_replace('_', ' ', $payment->payment_status)) }}</span>
                                @endif
                            </div>
                ...
                <div class="card card-hover">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <a href="{{ route('order_chat.index', ['order' => $order->order_id]) }}"
                ...
                <div class="col-lg-6">
                    <div class="card card-hover bg-info bg-opacity-10">
                        <div class="card-body text-center">
                            ...
                            <a href="{{ route('invoices.create', $order->order_id) }}"
                                class="btn btn-success btn-lg rounded-2 w-100">
